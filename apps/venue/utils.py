...
#         if venue_id == venue.id:  # Skip current venue
#             continue
...
#     location_feature_loc = location_feature_loc * config.get('location_weight', 2.0) * 3  # 3x weight on location
...
#     # Use venue location but with reduced weight
#     location_feature_price = location_scaler.transform([[venue.lat, venue.lng]])
#     location_feature_price = location_feature_price * config.get('location_weight', 2.0) * 0.5  # 0.5x weight
...
#         if distance <= max_distance_km * 2:  # Allow wider radius for price matches
